...
tslib_1.__decorate(
  ...
  UserOrderByWithAggregationInput.prototype,
  "id",
  void 0
);
tslib_1.__decorate(
...
tslib_1.__decorate(
  [
    TypeGraphQL.Field(
      (_type) =>
        UserCountOrderByAggregateInput_1.UserCountOrderByAggregateInput,
      {
        nullable: true,
      }
    ),
...
tslib_1.__decorate(
  [
    TypeGraphQL.Field(
      (_type) => UserMaxOrderByAggregateInput_1.UserMaxOrderByAggregateInput,
      {
        nullable: true,
      }
    ),
    tslib_1.__metadata(
      "design:type",
      UserMaxOrderByAggregateInput_1.UserMaxOrderByAggregateInput
    ),
  ],
  UserOrderByWithAggregationInput.prototype,
  "_max",
...
tslib_1.__decorate(
  [
    TypeGraphQL.Field(
      (_type) => UserMinOrderByAggregateInput_1.UserMinOrderByAggregateInput,
      {
        nullable: true,
      }
    ),
    tslib_1.__metadata(
      "design:type",
      UserMinOrderByAggregateInput_1.UserMinOrderByAggregateInput
    ),
  ],
  UserOrderByWithAggregationInput.prototype,
  "_min",
