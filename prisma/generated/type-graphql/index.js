...
const crudResolversImport = tslib_1.__importStar(
  require("./resolvers/crud/resolvers-crud.index")
);
const relationResolversImport = tslib_1.__importStar(
  require("./resolvers/relations/resolvers.index")
);
