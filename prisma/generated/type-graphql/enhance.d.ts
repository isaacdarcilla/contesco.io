...
declare const crudResolversMap: {
  ...
  Contestant: typeof crudResolvers.ContestantCrudResolver;
};
...
export declare function applyResolversEnhanceMap(
...
export declare function applyArgsTypesEnhanceMap(
...
declare const relationResolversMap: {
  ...
  Contestant: typeof relationResolvers.ContestantRelationsResolver;
};
...
export declare function applyRelationResolversEnhanceMap(
...
export declare function applyModelsEnhanceMap(
  modelsEnhanceMap: ModelsEnhanceMap
): void;
...
export declare function applyInputTypesEnhanceMap(
