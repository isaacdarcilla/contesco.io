...
export async function CustomSendVerificationRequest(params: {
  ...
  const result = await transport.sendMail({
    to: identifier,
    from: provider.from,
    subject: `Sign in to ${process.env.NEXT_APP_NAME} with a link!`,
    text: text({ url, host }),
                        ...
                        <td class="sm-px-6" style="padding-left: 40px; padding-right: 40px">
                          <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              ...
                              <td align="right">
                                <a href="${process.env.NEXTAUTH_URL}" class="dark-text-gray-900 dark-bg-gray-50 hover-bg-slate-100" style="text-decoration: none; display: inline-block; border-radius: 8px; background-color: #f9fafb; padding: 7px 12px; text-align: center; font-size: 12px; font-weight: 700; color: #191847; box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.06), 0px 1px 3px rgba(0, 0, 0, 0.1)">
                                  <!--[if mso
                                    ]><i
                                      style="
                                        letter-spacing: 24px;
                            ...
                            <tr>
                              <td>
                                ...
                                <p class="dark-text-gray-50" style="margin: 0; font-size: 16px; line-height: 26px; color: #191847">  
                                  We use this password-free sign in button so you don't
              ...
              <tr>
                <td style="padding-left: 40px; padding-right: 40px">
                  ...
                  <p style="margin: 0; font-size: 12px; line-height: 16px">
                    ...
                    <br>
                    <br>
                    Virac, Catanduanes Island, Bicol Region, Philippines 4800
                  </p>
                  <div style="line-height: 16px">&zwnj;</div>
                  <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-block sm-w-full">
                        <a href="${process.env.NEXTAUTH_URL}/terms" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                          Terms &amp; Conditions
                        </a>
                      </td>
                      ...
                      <td class="sm-block sm-w-full">
                        <a href="${process.env.NEXTAUTH_URL}/privacy" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                          Privacy Policy
                        </a>
                      </td>
                      <td class="sm-block sm-px-0" style="padding-left: 12px; padding-right: 12px">
                  ...
                  <div style="line-height: 16px">&zwnj;</div>
                  <p style="margin: 0; font-size: 12px; line-height: 16px">
                    This message was sent to ${process.env.NEXTAUTH_URL}.</p>
